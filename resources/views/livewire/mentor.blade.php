    ...
    <div class="row">
      <div class="card w-75 m-auto">
        ...
        <div class="card-body ">
          ...
          <div class="mb-3">
            <label for="" class="form-label">Family</label>
            <select class="form-select form-select-sm" wire:model="family" aria-label=".form-select-sm example">
              <option selected>Choose</option>
          ...
          <div class="mb-3">
             <label for="">Whats's your nature of work and where*</label>
             <input type="text" wire:model="work_status" id="" class="form-control">
             @error('work_status') <span class="text-danger">{{ $message }}</span> @enderror
          </div>
          <div class="mb-3">
            <label for="" class="form-label">What is your highest level of education?</label>
            <select class="form-select form-select-sm" wire:model="level_of_education" aria-label=".form-select-sm example">
              <option selected>Choose</option>
            ...
            @error('level_of_education') <span class="text-danger">{{ $message }}</span> @enderror
          </div>
          <div class="mb-3">
            <label for="">How many years of work experience do you have?</label>
            <input type="text" wire:model="work_experience" id="" class="form-control">
            @error('work_experience') <span class="text-danger">{{ $message }}</span> @enderror
         </div>
          <div class="mb-3">
            <label for="" class="form-label">Have you been a mentor before?</label>
            <select class="form-select form-select-sm" wire:model="have_you_been_a_mentor_before" aria-label=".form-select-sm example">
              <option selected>Choose</option>
              <option value="yes">Yes</option>
              <option value="no">No</option>
            </select>
            @error('have_you_been_a_mentor_before') <span class="text-danger">{{ $message }}</span> @enderror
          </div>
          <div class="mb-3">
            <label for="">If yes how many years of mentoring experience do you have?</label>
            <input type="text" wire:model="mentoring_experience" id="" class="form-control">
            @error('mentoring_experience') <span class="text-danger">{{ $message }}</span> @enderror
         </div>
          <div class="mb-3">
            <label for="">Is there anything from your professional experience you would like your mentee to know</label>
            <input type="text" wire:model="professional_experience" id="" class="form-control">
            @error('professional_experience') <span class="text-danger">{{ $message }}</span> @enderror
         </div>
          <div class="mb-3">
            <label for=""> What accomplishment are you most proud of and why?</label>
            <input type="text" wire:model="accomplishment" id="" class="form-control">
            @error('accomplishment') <span class="text-danger">{{ $message }}</span> @enderror
         </div>
          <div class="mb-3">
            <label for=""> Any life experience you want to share that makes you want to mentor other?</label>
            <input type="text" name="" id="mentoring_experience" class="form-control">
            @error('mentoring_experience') <span class="text-danger">{{ $message }}</span> @enderror
         </div>
          <div class="mb-3">
            <label for="">What are your goals and objectives?</label>
            <input type="text" wire:model="goals_and_objectives" id="" class="form-control">
            @error('goals_and_objectives') <span class="text-danger">{{ $message }}</span> @enderror
         </div>
          <div class="mb-3">
            <label for="">Why do you want to be a mentor? What would you hope to achieve from it?</label>
          ...
          <div class="mb-3">
            <label for="">What relevant skill do you have? </label>
            <input type="text" wire:model="skill" id="" class="form-control">
            @error('skill') <span class="text-danger">{{ $message }}</span> @enderror
         </div>
         <div class="mb-3">
          <label for="" class="form-label">Please indicate how you would prefer to meet with your mentee.</label>
         ...
         <div class="mb-3">
          <label for="" class="form-label">How often would you be prepared to have contact with your mentee?</label>
