...
@section('title', 'Blog Tag | Gritinai')
@section('content')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#smallModal">Create New Tag</h4>
